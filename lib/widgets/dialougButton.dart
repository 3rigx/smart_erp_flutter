...
import 'package:smart_erp_flutter/Utils/colors.dart';
    ...
    return Padding(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
            backgroundColor:
                widget.color.isNull ? AppColors.MAIN_BACKGROUND : widget.color,
        ...
        icon: Icon(
          CupertinoIcons.add,
          color: widget.iconColor.isNull ? Colors.white : widget.iconColor,
        ),
        label: Text(
          widget.name,
